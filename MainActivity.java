...
{
    if(URLUtil.isValidUrl(txt)){
        txt=txt.replace("http://","").replace("http:// www.","").replace("www.","");
        news=txt;
        urlFlag=true;
        networkCheck();
    }
...
*/
        ...
        protected void onPostExecute(Void v) {
          /*  if (progressDialog != null)
           ...
           // etNews.setText(url1);
            Toast.makeText(getApplicationContext(),"Here is the Result!",Toast.LENGTH_LONG).show();
            if(flag==1) {
